            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-red-50 p-6 rounded-lg">
                ...
                <p className="text-gray-700">
                  We've built communication systems for entire city departments. If you need organizational 
                  transformation alongside personal development, we speak that language.
                </p>
              </div>
              ...
              <div className="bg-red-50 p-6 rounded-lg">
                ...
                <p className="text-gray-700">
                  Twenty years as journalist and speechwriter. I know what reporters want because I was one. 
                  I know what executives face because I've written speeches at 3 AM during crisis.
                </p>
              </div>
            </div>
          </motion.div>
